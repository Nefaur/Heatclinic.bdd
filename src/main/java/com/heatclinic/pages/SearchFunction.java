...
public class SearchFunction {
	...
	public void enterSearch(DataTable queries) {
		...
		SEARCH.sendKeys((list.get(i).get(0)));
			 }
	}
	...
	public void selectQuery() {
		...
		if(list.get(i).getText().contains(SEARCH.getText())){
		list.get(i).click();
		break;
			}
		}
	...
	public void selectResult(int resultnumber) {
		String result_xpath="/html[1]/body[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div["+resultnumber+"]/div[1]/a[1]/div[1]";
