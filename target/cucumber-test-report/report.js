$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/main/resources/TestResource/Features/InvalidLogin.feature");
formatter.feature({
...
formatter.uri("src/main/resources/TestResource/Features/SearchTest.feature");
formatter.feature({
...
formatter.uri("src/main/resources/TestResource/Features/ValidLogin.feature");
formatter.feature({
...
formatter.uri("src/main/resources/TestResource/Features/ValidUserCheckout.feature");
formatter.feature({
